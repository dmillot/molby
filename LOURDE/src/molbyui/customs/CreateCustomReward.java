...
public class CreateCustomReward extends CreateCustom {

    private RewardController controller;

    public void setController(RewardController controllerParam){
        ...
        buttonMolby.setOnMouseClicked(mouseEvent -> {
            ...
            if (file != null && isPicture(file)) {
                ...
                try {
                    ...
                    Files.copy(file.toPath(),  Paths.get("./src/view/img/reward/wait.jpg"), options);
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
