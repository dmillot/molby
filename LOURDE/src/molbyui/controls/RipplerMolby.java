...
public class RipplerMolby extends StackPane {
    ...
    protected RippleGeneratorMolby rippler;
     ...
     * @param control
     */
    public RipplerMolby(Node control) {
     ...
     */
    public RipplerMolby(Node control, RipplerPos pos) {
     ...
     */
    public RipplerMolby(Node control, RipplerMask mask) {
     ...
     * @param pos     can be either FRONT/BACK (position the ripple effect infront of or behind the control)
     */
    public RipplerMolby(Node control, RipplerMask mask, RipplerPos pos) {
        initialize();
    ...
    public RipplerMolby(Node control, RipplerMask mask, Paint paint){
        this(control, mask, RipplerPos.FRONT);
        this.setRipplerFill(paint);
    }

    public RipplerMolby(Node control, RipplerMask mask, Paint paint, Double XPosition){
        this(control, mask, RipplerPos.FRONT);
        this.setRipplerFill(paint);
        this.setLayoutX(XPosition);
    }

    public RipplerMolby(Node control, RipplerMask mask, Paint paint, Double XPosition, Boolean expand){
        this(control, mask, RipplerPos.FRONT);
        this.setRipplerFill(paint);
        if(expand){
    ...
    public RipplerMolby(Node control, RipplerMask mask, Paint paint, Double XPosition, PaneMolby paneRow){
        this(control, mask, RipplerPos.FRONT);
        this.setRipplerFill(paint);
        this.setLayoutX(XPosition);
        this.layoutYProperty().bind(paneRow.heightProperty().subtract(this.heightProperty()).divide(2));
    }

    public RipplerMolby(Node control, RipplerMask mask, Paint paint, Double XPosition, PaneMolby paneRow, Boolean expand){
        this(control, mask, RipplerPos.FRONT);
        this.setRipplerFill(paint);
        this.setLayoutX(XPosition);
        if(expand){
    ...
    protected final void createRippleUI() {
        ...
        rippler = new RippleGeneratorMolby();
     ...
     * over 0.6 seconds
     */
    final class RippleGeneratorMolby extends Group {
        ...
        private final class OverLayRipple extends Rectangle {
            ...
            OverLayRipple() {
                ...
                if (RipplerMolby.this.getChildrenUnmodifiable().contains(control)) {
                    double diffMinX = Math.abs(control.getBoundsInLocal().getMinX() - control.getLayoutBounds().getMinX());
                    double diffMinY = Math.abs(control.getBoundsInLocal().getMinY() - control.getLayoutBounds().getMinY());
                    Bounds bounds = control.getBoundsInParent();
    ...
    private void resetOverLay() {
        if (rippler.overlayRect != null) {
            rippler.overlayRect.inAnimation.stop();
            final RippleGeneratorMolby.OverLayRipple oldOverlay = rippler.overlayRect;
    ...
    private static final class StyleableProperties {
        private static final CssMetaData<RipplerMolby, Boolean> RIPPLER_RECENTER =
                new CssMetaData<RipplerMolby, Boolean>("-jfx-rippler-recenter",
                        BooleanConverter.getInstance(), false) {
                    @Override
                    public boolean isSettable(RipplerMolby control) {
                        return control.ripplerRecenter == null || !control.ripplerRecenter.isBound();
                    }

                    @Override
                    public StyleableProperty<Boolean> getStyleableProperty(RipplerMolby control) {
                        return control.ripplerRecenterProperty();
                    }
                };
        private static final CssMetaData<RipplerMolby, Boolean> RIPPLER_DISABLED =
                new CssMetaData<RipplerMolby, Boolean>("-jfx-rippler-disabled",
                        BooleanConverter.getInstance(), false) {
                    @Override
                    public boolean isSettable(RipplerMolby control) {
        ...
        private static final CssMetaData<RipplerMolby, Paint> RIPPLER_FILL =
                new CssMetaData<RipplerMolby, Paint>("-jfx-rippler-fill",
                    ...
                    @Override
                    public StyleableProperty<Paint> getStyleableProperty(RipplerMolby control) {
                        return control.ripplerFillProperty();
                    }
                };
        private static final CssMetaData<RipplerMolby, Number> RIPPLER_RADIUS =
                new CssMetaData<RipplerMolby, Number>("-jfx-rippler-radius",
                    ...
                    @Override
                    public StyleableProperty<Number> getStyleableProperty(RipplerMolby control) {
                        return control.ripplerRadiusProperty();
                    }
                };
        private static final CssMetaData<RipplerMolby, RipplerMask> MASK_TYPE =
                new CssMetaData<RipplerMolby, RipplerMask>("-jfx-mask-type",
                        RipplerMaskTypeConverterMolby.getInstance(), RipplerMask.RECT) {
                    @Override
                    public boolean isSettable(RipplerMolby control) {
                    ...
                    @Override
                    public StyleableProperty<RipplerMask> getStyleableProperty(RipplerMolby control) {
